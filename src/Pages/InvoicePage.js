...
function InvoicePage() {
    ...
    const handleOnChange = (e) => {
        ...
        if (e.target.name === "customerName") {
            ...
            setCustomer({...customer,customerName:e.target.value,customerAddress:selectedCustomer.customerAddress,customerEmail:selectedCustomer.customerEmail,customerMobile:selectedCustomer.customerMobile})
        }
    }
    ...
    const handleOnClick = (e) => {
        e.preventDefault();
        if (!customer.customerName || !customer.invoiceNo || !customer.sellerName || !customer.invoiceDate || !customer.orderDate || !customer.status || !customer.type) {
